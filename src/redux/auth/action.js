...
export function createBsuinessProfile(value, countryCityValue, id, resolve, reject) {
  return { type: actionTypes.CREATE_BUSINESS_PROFILE, value, countryCityValue, id, resolve, reject };
}
...
export function savePlanAction(value, couponId, business_id, price, resolve, reject) {
  return { type: actionTypes.SAVE_PLAN_ACTION, value, couponId, business_id, price, resolve, reject };
}
export function cuoponCodeValid(value, business_id, resolve, reject) {
  return { type: actionTypes.CUOPON_CODE_VALID, value, business_id, resolve, reject };
}
